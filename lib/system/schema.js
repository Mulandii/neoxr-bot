module.exports = (m, env) => {
   ...
   if (setting) {
      ...
      if (!('owners' in setting)) setting.owners = ['19143707212']
      ...
      if (!('link' in setting)) setting.link = 'https://chat.whatsapp.com/4OaImtQwH48CtlR0yt4Ff'
   } else {
      global.db.setting = {
         autodownload: true,
         antispam: false,
         ...
         link: 'https://chat.whatsapp.com/4OaImtQwH48CtlR0yt4Ff'
      }
   }
}
